...
<head>
    ...
    <title>เตือนการจองห้อง</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #ffc107; padding: 20px; border-radius: 5px; margin-bottom: 20px;">
        <h2 style="color: #333; margin-top: 0;">⏰ เตือน: การจองห้องของคุณจะเริ่มในอีก {{ $hoursBefore }} ชั่วโมง</h2>
    </div>
    ...
    <div style="background-color: #ffffff; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
        ...
        <p>นี่เป็นการแจ้งเตือนว่าการจองห้องของคุณจะเริ่มในอีก <strong>{{ $hoursBefore }} ชั่วโมง</strong></p>
