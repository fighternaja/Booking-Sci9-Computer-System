...
<head>
    ...
    <title>เชิญเข้าร่วมการจองห้อง</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #007bff; padding: 20px; border-radius: 5px; margin-bottom: 20px;">
        <h2 style="color: #ffffff; margin-top: 0;">📧 เชิญเข้าร่วมการจองห้อง</h2>
    </div>

    <div style="background-color: #ffffff; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
        <p>สวัสดี,</p>

        <p><strong>{{ $organizer->name }}</strong> เชิญคุณเข้าร่วมการจองห้อง</p>
        ...
        <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0;">
            ...
            @endif
            @if($room->location)
                <p><strong>สถานที่:</strong> {{ $room->location }}</p>
            @endif
        </div>

        <p style="color: #666; font-size: 14px;">กรุณาเข้าสู่ระบบเพื่อตอบรับหรือปฏิเสธการเชิญ</p>
    </div>
