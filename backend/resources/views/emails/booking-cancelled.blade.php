...
<head>
    ...
    <title>การจองห้องถูกยกเลิก</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #6c757d; padding: 20px; border-radius: 5px; margin-bottom: 20px;">
        <h2 style="color: #ffffff; margin-top: 0;">🚫 การจองห้องถูกยกเลิก</h2>
    </div>
    ...
    <div style="background-color: #ffffff; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
        ...
        <p>การจองห้องของคุณถูกยกเลิกแล้ว</p>

        <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <h3 style="margin-top: 0; color: #2c3e50;">รายละเอียดการจองที่ถูกยกเลิก</h3>
            ...
            @if($booking->cancellation_reason)
                <div style="background-color: #fff3cd; padding: 10px; border-radius: 5px; margin-top: 10px;">
                    <p style="margin: 0;"><strong>เหตุผล:</strong> {{ $booking->cancellation_reason }}</p>
                </div>
            @endif
        </div>

        <p style="color: #666; font-size: 14px;">คุณสามารถจองห้องใหม่ได้ตามต้องการ</p>
    </div>
